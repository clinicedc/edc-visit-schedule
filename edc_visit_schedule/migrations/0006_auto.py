...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'VisitDefinition', fields ['title']
        db.create_index('bhp_form_visitdefinition', ['title'])


    def backwards(self, orm):
        # Removing index on 'VisitDefinition', fields ['title']
        db.delete_index('bhp_form_visitdefinition', ['title'])
