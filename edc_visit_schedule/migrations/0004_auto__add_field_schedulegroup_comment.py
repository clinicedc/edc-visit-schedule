...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ScheduleGroup.comment'
        db.add_column('bhp_form_schedulegroup', 'comment', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ScheduleGroup.comment'
        db.delete_column('bhp_form_schedulegroup', 'comment')
