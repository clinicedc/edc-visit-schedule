...
import edc_visit_schedule.validators
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visit_tracking_content_type_map', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='edc_content_type_map.ContentTypeMap', validators=[edc_visit_schedule.validators.is_visit_tracking_model], verbose_name='Visit Tracking Model')),
            ],
            options={
