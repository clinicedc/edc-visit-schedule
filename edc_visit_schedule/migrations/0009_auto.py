...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'MembershipForm', fields ['user_modified']
        db.create_index('bhp_visit_membershipform', ['user_modified'])

        # Adding index on 'MembershipForm', fields ['user_created']
        db.create_index('bhp_visit_membershipform', ['user_created'])

        # Adding index on 'ScheduleGroup', fields ['user_modified']
        db.create_index('bhp_visit_schedulegroup', ['user_modified'])

        # Adding index on 'ScheduleGroup', fields ['user_created']
        db.create_index('bhp_visit_schedulegroup', ['user_created'])

        # Adding index on 'VisitDefinition', fields ['user_modified']
        db.create_index('bhp_visit_visitdefinition', ['user_modified'])

        # Adding index on 'VisitDefinition', fields ['user_created']
        db.create_index('bhp_visit_visitdefinition', ['user_created'])


    def backwards(self, orm):
        # Removing index on 'VisitDefinition', fields ['user_created']
        db.delete_index('bhp_visit_visitdefinition', ['user_created'])

        # Removing index on 'VisitDefinition', fields ['user_modified']
        db.delete_index('bhp_visit_visitdefinition', ['user_modified'])

        # Removing index on 'ScheduleGroup', fields ['user_created']
        db.delete_index('bhp_visit_schedulegroup', ['user_created'])

        # Removing index on 'ScheduleGroup', fields ['user_modified']
        db.delete_index('bhp_visit_schedulegroup', ['user_modified'])

        # Removing index on 'MembershipForm', fields ['user_created']
        db.delete_index('bhp_visit_membershipform', ['user_created'])

        # Removing index on 'MembershipForm', fields ['user_modified']
        db.delete_index('bhp_visit_membershipform', ['user_modified'])
