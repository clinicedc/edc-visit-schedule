...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'MembershipForm', fields ['hostname_created']
        db.create_index('bhp_form_membershipform', ['hostname_created'])

        # Adding index on 'MembershipForm', fields ['hostname_modified']
        db.create_index('bhp_form_membershipform', ['hostname_modified'])

        # Adding index on 'ScheduleGroup', fields ['hostname_created']
        db.create_index('bhp_form_schedulegroup', ['hostname_created'])

        # Adding index on 'ScheduleGroup', fields ['hostname_modified']
        db.create_index('bhp_form_schedulegroup', ['hostname_modified'])

        # Adding index on 'VisitDefinition', fields ['hostname_created']
        db.create_index('bhp_form_visitdefinition', ['hostname_created'])

        # Adding index on 'VisitDefinition', fields ['code']
        db.create_index('bhp_form_visitdefinition', ['code'])

        # Adding index on 'VisitDefinition', fields ['hostname_modified']
        db.create_index('bhp_form_visitdefinition', ['hostname_modified'])


    def backwards(self, orm):
        # Removing index on 'VisitDefinition', fields ['hostname_modified']
        db.delete_index('bhp_form_visitdefinition', ['hostname_modified'])

        # Removing index on 'VisitDefinition', fields ['code']
        db.delete_index('bhp_form_visitdefinition', ['code'])

        # Removing index on 'VisitDefinition', fields ['hostname_created']
        db.delete_index('bhp_form_visitdefinition', ['hostname_created'])

        # Removing index on 'ScheduleGroup', fields ['hostname_modified']
        db.delete_index('bhp_form_schedulegroup', ['hostname_modified'])

        # Removing index on 'ScheduleGroup', fields ['hostname_created']
        db.delete_index('bhp_form_schedulegroup', ['hostname_created'])

        # Removing index on 'MembershipForm', fields ['hostname_modified']
        db.delete_index('bhp_form_membershipform', ['hostname_modified'])

        # Removing index on 'MembershipForm', fields ['hostname_created']
        db.delete_index('bhp_form_membershipform', ['hostname_created'])
