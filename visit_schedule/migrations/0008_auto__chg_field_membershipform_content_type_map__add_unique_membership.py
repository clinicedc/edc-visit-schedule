...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('bhp_visit_membershipform', 'content_type_map_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['bhp_content_type_map.ContentTypeMap']))
        # Adding unique constraint on 'MembershipForm', fields ['content_type_map']
        db.create_unique('bhp_visit_membershipform', ['content_type_map_id'])


        # Changing field 'VisitDefinition.code'
        db.alter_column('bhp_visit_visitdefinition', 'code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=6))
        # Adding unique constraint on 'VisitDefinition', fields ['code']
        db.create_unique('bhp_visit_visitdefinition', ['code'])


    def backwards(self, orm):
        # Removing unique constraint on 'VisitDefinition', fields ['code']
        db.delete_unique('bhp_visit_visitdefinition', ['code'])

        # Removing unique constraint on 'MembershipForm', fields ['content_type_map']
        db.delete_unique('bhp_visit_membershipform', ['content_type_map_id'])


        # Changing field 'MembershipForm.content_type_map'
        db.alter_column('bhp_visit_membershipform', 'content_type_map_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_content_type_map.ContentTypeMap']))

        # Changing field 'VisitDefinition.code'
        db.alter_column('bhp_visit_visitdefinition', 'code', self.gf('django.db.models.fields.CharField')(max_length=4))
