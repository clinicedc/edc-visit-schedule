...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MembershipForm.category'
        db.alter_column('bhp_visit_membershipform', 'category', self.gf('django.db.models.fields.CharField')(max_length=35, unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'MembershipForm.category'
        db.alter_column('bhp_visit_membershipform', 'category', self.gf('django.db.models.fields.CharField')(unique=True, max_length=25, null=True))
