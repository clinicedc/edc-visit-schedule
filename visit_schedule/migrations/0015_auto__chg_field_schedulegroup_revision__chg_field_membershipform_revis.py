...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ScheduleGroup.revision'
        db.alter_column('bhp_visit_schedulegroup', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'MembershipForm.revision'
        db.alter_column('bhp_visit_membershipform', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'VisitDefinition.revision'
        db.alter_column('bhp_visit_visitdefinition', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

    def backwards(self, orm):

        # Changing field 'ScheduleGroup.revision'
        db.alter_column('bhp_visit_schedulegroup', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'MembershipForm.revision'
        db.alter_column('bhp_visit_membershipform', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'VisitDefinition.revision'
        db.alter_column('bhp_visit_visitdefinition', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
