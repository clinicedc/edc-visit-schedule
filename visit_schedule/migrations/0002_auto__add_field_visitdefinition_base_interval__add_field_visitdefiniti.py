...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VisitDefinition.base_interval'
        db.add_column('bhp_form_visitdefinition', 'base_interval', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'VisitDefinition.base_interval_unit'
        db.add_column('bhp_form_visitdefinition', 'base_interval_unit', self.gf('django.db.models.fields.CharField')(default='D', max_length=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'VisitDefinition.base_interval'
        db.delete_column('bhp_form_visitdefinition', 'base_interval')

        # Deleting field 'VisitDefinition.base_interval_unit'
        db.delete_column('bhp_form_visitdefinition', 'base_interval_unit')
