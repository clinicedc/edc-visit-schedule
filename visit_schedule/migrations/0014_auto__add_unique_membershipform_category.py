...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'MembershipForm', fields ['category']
        db.create_unique('bhp_visit_membershipform', ['category'])


    def backwards(self, orm):
        # Removing unique constraint on 'MembershipForm', fields ['category']
        db.delete_unique('bhp_visit_membershipform', ['category'])
