...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ScheduleGroup.revision'
        db.add_column('bhp_visit_schedulegroup', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MembershipForm.revision'
        db.add_column('bhp_visit_membershipform', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'VisitDefinition.revision'
        db.add_column('bhp_visit_visitdefinition', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ScheduleGroup.revision'
        db.delete_column('bhp_visit_schedulegroup', 'revision')

        # Deleting field 'MembershipForm.revision'
        db.delete_column('bhp_visit_membershipform', 'revision')

        # Deleting field 'VisitDefinition.revision'
        db.delete_column('bhp_visit_visitdefinition', 'revision')
