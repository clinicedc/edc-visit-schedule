...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VisitDefinition.visit_tracking_content_type_map'
        db.add_column('bhp_visit_visitdefinition', 'visit_tracking_content_type_map',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_content_type_map.ContentTypeMap'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VisitDefinition.visit_tracking_content_type_map'
        db.delete_column('bhp_visit_visitdefinition', 'visit_tracking_content_type_map_id')
