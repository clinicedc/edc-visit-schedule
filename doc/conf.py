# -*- coding: utf-8 -*-
#
# bhp_visit documentation build configuration file, created by
...
htmlhelp_basename = 'bhp_visitdoc'
...
latex_documents = [
  ('index', 'bhp_visit.tex', u'bhp\\_visit Documentation',
...
man_pages = [
    ('index', 'bhp_visit', u'bhp_visit Documentation',
...
texinfo_documents = [
  ('index', 'bhp_visit', u'bhp_visit Documentation',
   u'erik van widenfelt', 'bhp_visit', 'One line description of project.',
   'Miscellaneous'),
]
